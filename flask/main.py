...
def home():
    if request.method == 'GET':
        ...
        if request.form['dateAfter'] != "":
            parameters['pubStartDate'] = request.form['dateAfter'] + 'T00:00:00.000' if request.form[
                                                                                            'dateAfter'] != "" else ""
        if request.form['dateBefore'] != "":
            parameters['pubEndDate'] = request.form['dateBefore'] + 'T00:00:00.000' if request.form[
                                                                                           'dateBefore'] != "" else ""
